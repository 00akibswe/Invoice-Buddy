...
//Create Invoice MySQL statement
  ...
  { 
    ...
    $statement->execute(
      ...
      //Update Invoice MySQL statement
      $statement = $connect->prepare("
        UPDATE tbl_order 
  ...
  //Delete Invoice MySQL statement
...
<body>
    ...
    <div class="container-fluid">
      ...
      ?>
                            ...
                            <table id="invoice-item-table" class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="order_item_price[]" id="order_item_price1"
                                            data-srno="1" class="form-control input-sm number_only order_item_price" />
                                    </td>
                                    ...
                                    <td><input type="text" name="order_item_tax3_rate[]" id="order_item_tax3_rate1"
                                            data-srno="1"
                                            class="form-control input-sm number_only order_item_tax3_rate" /></td>
                                    <td><input type="text" name="order_item_tax3_amount[]" id="order_item_tax3_amount1"
                                            data-srno="1" readonly
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#add_row', function() {
                ...
                html_code +=
                    '<td><input type="text" name="order_item_tax3_rate[]" id="order_item_tax3_rate' +
                    count + '" data-srno="' + count +
                    '" class="form-control input-sm number_only order_item_tax3_rate" /></td>';
                html_code +=
                    '<td><input type="text" name="order_item_tax3_amount[]" id="order_item_tax3_amount' +
                    count + '" data-srno="' + count +
                    ...
                    if (quantity > 0) {
                        ...
                        if (price > 0) {
                            ...
                            item_total = parseFloat(actual_amount) + parseFloat(tax1_amount) + parseFloat(
                                tax2_amount) + parseFloat(tax3_amount);
            ...
            //Which Items will not change or Blur
                    ...
                    ?>
                                <tr>
                                    ...
                                    <td><input type="text" name="order_item_tax3_rate[]"
                                            id="order_item_tax3_rate<?php echo $m; ?>" data-srno="<?php echo $m; ?>"
                                    ...
                                    <td><input type="text" name="order_item_tax3_amount[]"
                                            id="order_item_tax3_amount<?php echo $m; ?>" data-srno="<?php echo $m; ?>"
                                            readonly class="form-control input-sm order_item_tax3_amount"
      ...
      ?>
      <!-- Dashboard Work. -->
        <h2 align="center" style="margin-top:15px">Invoice Buddy</h2>
        <br />
        <div align="right">
            <a href="invoice.php?add=1" class="btn btn-primary btn-lg">Create</a>
            <a href="index.php" class="btn btn-outline-danger btn-sm"> Log out</a>
        </div>
        <br />
        <table id="data-table" class="table table-bordered table-striped">
            ...
            <?php
            //Generating Buttons for every row
        if($total_rows > 0)
        {
          foreach($all_result as $row)
          {
            echo '
              <tr>
                ...
                <td><a href="print_invoice.php?pdf=1&id='.$row["order_id"].'" class="btn btn-primary">PDF</a></td>
                <td><a href="invoice.php?update=1&id='.$row["order_id"].'" class="btn btn-warning">Edit</a></td>
                <td><a href="invoice.php?delete=1&id='.$row["order_id"].'" class="btn btn-danger">Delete</a></td>
                <td><a href="send-mail.php?mail=1&id='.$row["order_id"].'" class="btn btn-primary">Send</a></td>
              </tr>
            ';
          }
        }
    ...
    <footer class="page-footer font-small blue">
        <div class="footer-copyright text-center py-3">Developed BY</br>Error Squad</br>Copyright© 2019
            <a href="https://vshungry.com/">vsHungry Blog.</a>
        </div>
    </footer>
</body>
</html>